...
class Character(object):
    ...
    def take_damage(self, damage):
        ...
        if self.life <= 0:
            raise utils.WinException(self.opponent.my_number)
        if final_damage:
...
class Adjenna(Character):
    ...
    def petrify(self):
        ...
        if self.petrification > 5:
            ...
            raise utils.WinException(self.my_number)
...
class Eustace(Character):
    ...
    def input_ante(self, pair):
        if self.pool:
            ...
            return utils.ReadNumber(0, len(self.pool) + 1)
        else:
            return 0
...
class Luc(Character):
    ...
    def input_ante(self, pair):
        ...
        if p > 0:
            ...
            while True:
                ante = utils.ReadNumber(0, len(self.pool) + 1)
...
class BasiliskGaze(Finisher):
    ...
    def hit_trigger(self):
        raise utils.WinException(self.me.my_number)
